package states
{
	 ...
	 */
	public class Menu extends EventDispatcher implements IState
	{
		 ...
		 */
		public function Menu(stage:Stage = null, container: Sprite = null, sFlag:Boolean = true, rFlag:Boolean = false) 
		{
			this._stage = stage;
...
//-------------------------------------------------------------------------------------------------	
		...
		public function enterState():void
		{
			//Background
			bkgr = new Shape();
			bkgr.graphics.beginFill(0x000000, 0.5);
